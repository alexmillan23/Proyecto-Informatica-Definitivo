...
def generate_airspace_kml(airspace):
    ...
    # Añadir estilos
    kml_content += add_style("navpoint_style", "ff0000ff",
                             icon="http://maps.google.com/mapfiles/kml/shapes/placemark_circle.png")
    kml_content += add_style("airport_style", "ff00ff00",
                             icon="http://maps.google.com/mapfiles/kml/shapes/airports.png")
    kml_content += add_style("segment_style", "ffffff00",
                             width="1")  # Color celeste en formato AABBGGRR (el color aparece invertido en KML)
...
def generate_path_kml(path_name, path_points):
    ...
    # Añadir estilos
    kml_content += add_style("point_style", "ff0000ff",
                             icon="http://maps.google.com/mapfiles/kml/shapes/placemark_circle.png")
...
def generate_neighbors_kml(central_point, neighbors, airspace=None):
    ...
    # Añadir estilos
    kml_content += add_style("central_point_style", "ff0000ff",
                             icon="http://maps.google.com/mapfiles/kml/shapes/placemark_circle.png")
    kml_content += add_style("neighbor_point_style", "ff00ff00",
                             icon="http://maps.google.com/mapfiles/kml/shapes/placemark_circle.png")
