...
def mostrar_espacio_aereo(app, punto_destacado=None, vecinos=None, ruta=None):
    ...
    instructions_label = tk.Label(map_window, text=instructions_text, font=("Arial", 10), bg=app.tema["bg"],
                                  fg=app.tema["fg"])
...
class AplicacionNavegacionEspacioAereo(tk.Tk):
    def __init__(self):
        ...
        header_label = tk.Label(header_frame, text="FlyPath: Sistema de Navegación Aérea",
                                font=(self.tema["font_family"], self.tema["font_size_header"], "bold"), fg="white",
                                bg="#2c3e50")
        ...
        load_label = tk.Label(load_frame, text="Cargar y Visualizar Datos",
                              font=(self.tema["font_family"], self.tema["font_size_title"], "bold"), bg=self.tema["bg"],
                              fg=self.tema["fg"])
